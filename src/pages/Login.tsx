    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md text-center space-y-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-foreground">SheetSync</h1>
            <p className="text-muted-foreground mt-2 text-base">
              Compare and sync leads into your Google Sheets
            </p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-8 shadow-sm space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Connect your Google account to access and manage your spreadsheets.
            </p>
          </div>
        ...
        <p className="text-xs text-muted-foreground">
          SheetSync needs access to read and write your Google Sheets.
        </p>
      </div>
    </div>
  );
